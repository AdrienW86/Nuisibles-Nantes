      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-zinc-600">
            Experts en dératisation et désinsectisation à Nantes et agglomération. Intervention rapide et discrète.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-sm text-zinc-600">Nantes, 44000</span>
          <a href="tel:+33698144222" className="text-sm font-bold text-brand-green-600">06 98 14 42 22</a>
        </div>

        {/* Colonne 4 : Branding */}
        <div className="flex flex-col gap-2 justify-end">
          <p className="text-xs text-zinc-500">© {currentYear} Nuisibles Nantes.</p>
          <a 
