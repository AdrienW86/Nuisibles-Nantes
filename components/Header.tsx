      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-bold text-brand-green-600 tracking-[0.2em] uppercase">NANTES</span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="tel:+33698144222" className="bg-brand-green-600 text-white px-5 py-2.5 rounded-full font-bold text-sm hover:bg-brand-green-700 shadow-md">
            06 98 14 42 22
          </Link>
        </div>
      </nav>
