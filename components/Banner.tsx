...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <Image 
        src="/banner.png" 
        alt="Expert en lutte contre les nuisibles à Nantes" 
        fill
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl">
        ...
        <p className="text-lg md:text-xl text-zinc-100 mb-8">
          Intervention rapide à Nantes et sa région contre tous types de nuisibles. 
          Expertise certifiée et solutions durables.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:+33600000000" className="bg-brand-green-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-brand-green-700 transition shadow-xl">
            Appeler maintenant
          </a>
