    ...
    <div className="bg-white py-12 px-6">
      <article className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-zinc-900 mb-6">
          Dératisation à Nantes : Éradication efficace des rats et souris
        </h1>

        <BannerService 
          imageSrc ='/banner-deratisation.png'
          imageAlt='un technicien en train de surveiller un chantier à Nantes'
        />
        ...
        <p className="text-lg text-zinc-600 mb-8 leading-relaxed">
          ...
          rapidement sur <strong>Nantes et toute son agglomération</strong> pour une 
        ...
        <p className="text-zinc-600 mb-6">
          En tant que professionnels de la lutte contre les nuisibles à Nantes, nous appliquons 
        ...
        {/* Appel à l'action */}
          ...
          <LinkSticker 
            link1 = "/deratisation/nantes" description1 = "Dératisation à Nantes"
            link2 = "/deratisation/bouguenais" description2 = "Dératisation à Bouguenais"
          />
          <Sticker />
      </article>
    </div>
