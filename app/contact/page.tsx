      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-zinc-600">
            Une urgence ? Un besoin de prévention ? Contactez nos techniciens certifiés pour une intervention rapide sur Nantes et sa région.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+33698144222" className="text-xl font-bold hover:text-brand-green-400 transition">
                      06 98 14 42 22
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-medium">Nantes et 50km aux alentours</p>
                  </div>
                </div>
