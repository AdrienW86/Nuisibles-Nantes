      ...
      <article className="max-w-4xl mx-auto text-zinc-700">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p>
              La protection de vos données personnelles est une priorité pour <strong>Nuisibles Nantes</strong> (Entreprise PIERREUSE). Cette politique de confidentialité détaille les informations que nous collectons lors de votre navigation sur notre site et l'usage que nous en faisons.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Pour exercer ces droits, vous pouvez nous contacter à l'adresse suivante : <strong>contact@nuisibles-nantes.fr</strong>.
            </p>
          </section>
