    ...
    <div className="bg-white py-16 px-6">
      <article className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-zinc-900 mb-8">
          Votre expert en dératisation à Nantes
        </h1>

        <div className="prose prose-zinc max-w-none text-lg text-zinc-600 leading-relaxed space-y-6">
          <p>
            Depuis plusieurs années, nous intervenons sur <strong>Nantes et toute la Loire-Atlantique</strong> pour protéger 
        ...
        <div className="grid md:grid-cols-3 gap-6 my-12">
          <div className="bg-zinc-50 p-6 rounded-xl border border-zinc-100">
            ...
            <p className="text-sm text-zinc-600">Une connaissance parfaite du terrain nantais pour une intervention rapide, 7j/7.</p>
          </div>
          <div className="bg-zinc-50 p-6 rounded-xl border border-zinc-100">
        ...
        <div className="bg-brand-green-50 p-8 rounded-2xl border-l-4 border-brand-green-600">
          ...
          <p className="text-zinc-700 leading-relaxed">
            Chez <strong>Nuisibles Nantes</strong>, nous pensons que la confiance est la base de notre travail. 
