    ...
    <main className="max-w-4xl mx-auto py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/deratisation/nantes" className="hover:text-brand-green-600">Nantes Centre</Link></li>
            <li><Link href="//saint-herblain" className="hover:text-brand-green-600">Saint-Herblain</Link></li>
            <li><Link href="/intervention/reze" className="hover:text-brand-green-600">Rezé</Link></li>
            <li><Link href="/intervention/orvault" className="hover:text-brand-green-600">Orvault</Link></li>
