        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-none space-y-2 bg-zinc-50 p-6 rounded-xl border border-zinc-100">
              <li><strong>Propriétaire et Éditeur :</strong> Klenn PIERREUSE (Entrepreneur Individuel)</li>
              <li><strong>Nom commercial :</strong> Nuisibles Nantes (enregistré sous KLENN COUVERTURE)</li>
              <li><strong>Siège social :</strong> 108 RUE ARISTIDE BRIAND, 44400 REZE, FRANCE</li>
              <li><strong>SIREN :</strong> 798 282 695</li>
              <li><strong>SIRET :</strong> 798 282 695 00047</li>
              <li><strong>Code APE :</strong> 4391B</li>
              <li><strong>Téléphone :</strong> 06 98 14 42 22</li>
              <li><strong>Email :</strong> contact@nuisibles-nantes.fr</li>
              <li><strong>Directeur de la publication :</strong> Klenn PIERREUSE</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              L'entreprise PIERREUSE Klenn est propriétaire des droits de propriété intellectuelle et détient 
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              contactant : <strong>contact@nuisibles-nantes.fr</strong>.
            </p>
          </section>
